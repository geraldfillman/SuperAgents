...
REPORTS_DIR = Path("data/processed/quality_reports")
...
def _recommend_action(severity: str) -> str:
    actions = {
        "critical": "Review for archival or discontinuation. Verify if product is still active.",
        "high": "Re-verify against primary sources. Update or flag as uncertain.",
        "moderate": "Schedule verification. Check for recent sponsor/FDA updates.",
    }
