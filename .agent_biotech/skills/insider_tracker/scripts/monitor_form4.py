"""
Insider Tracker â€” Monitor Form 4
Detects and summarizes recent Form 4 insider transactions from cached SEC filings.
"""
...
OUT_DIR = Path("data/processed/insider_trades")
